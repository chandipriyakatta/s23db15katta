...
router.get('/', function (req, res) { 
    res.render('index', { title: 'electricappliances App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'electricappliances App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'electricappliances App Login', user : req.user }); 
}); 
